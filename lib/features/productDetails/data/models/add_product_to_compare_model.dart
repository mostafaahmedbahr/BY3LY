...
class AddProductToCompareModel {
  bool? status;
  String? message;
  List<Data>? data;

  AddProductToCompareModel({this.status, this.message, this.data});

  AddProductToCompareModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
